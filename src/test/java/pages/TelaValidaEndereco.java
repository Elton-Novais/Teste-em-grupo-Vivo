...
public class TelaValidaEndereco {
    ...
    public void validarEndereco() {
        ...
        WebElement confirmacao = navegador.findElement(By.xpath("(//span[@class='NkzuOd-trip-header-waypoint-V1ur5d'])[2]"));
        String texto = confirmacao.getText();
        Assert.assertEquals("Joalheria Pandora, Av. Pres. Juscelino Kubitschek, 2041 - Loja 255 - Vila Nova Conceição, São Paulo - SP, 04543-011", texto);
